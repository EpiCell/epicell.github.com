$(function() {
	...
	var cartodb_layer = {
		getTileUrl: function(coord, zoom) {
			...
			"?sql=SELECT monarch.cartodb_id, monarch.the_geom_webmercator FROM monarch, countries WHERE ST_Intersects(monarch.the_geom,countries.the_geom) AND countries.name = 'Mexico'";
		},
